...
<div>
    ...
    <form class="form-horizontal">
      ...
      <!--div class="form-group">
        <label class="control-label col-sm-2" for>PO No:</label>
        <input type="text" v-model="order.po_number" placeholder="Customer PO number"/>
      </div-->
    ...
    <button v-on:click.prevent="createOrder">Create Job</button>
    </div>
    ...
    methods: {
        ...
        async createOrder() {
            ...
            let newJob = await this.$axios
                ...
                this.newJob.job_number = this.newJob.yr_month + '-' + jobID
                console.log('get newJob =', this.newJob)
                await this.$axios.$post(`/jobs_jobnumber`, {
                    yr_month: this.newJob.yr_month, 
